...
const ADMIN_ITEMS: NavItem[] = [
  ...
  { to: "/admin/upload", label: "Subir", icon: Upload, isUpload: true },
...
function NavTab({ item, isActive }: { item: NavItem; isActive: boolean }) {
  ...
  return (
    <Link
      to={item.to}
      className="relative flex flex-1 flex-col items-center justify-center px-1 py-2.5 text-[10px] font-medium transition-all active:scale-95 active:bg-white/5 rounded-lg"
    >
